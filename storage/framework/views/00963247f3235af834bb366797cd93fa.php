...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="employee_id" name="employee_id" value="<?php echo e($string); ?>" readonly>
  </div>
  <div class="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\hr-pay-role\resources\views/workers/create.blade.php ENDPATH**/ ?>